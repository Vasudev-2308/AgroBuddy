      ...
      body: Column(
        children: [
          ...
          Container(
              ...
              child: const Text(
                "Ea commodo dolor mollit consectetur. Voluptate irure amet consectetur aliqua dolore sint incididunt voluptate laboris.",
                style: TextStyle(
                  fontSize: 18,
                ),
              )),
         ...
         GestureDetector(
          ...
          child: Container(
            ...
            child: const Center(
              child: Text("How to grow", style: TextStyle(color: Colors.white, fontSize: 23, fontWeight: FontWeight.bold),),
